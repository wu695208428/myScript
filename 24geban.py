...
# 需要customerId,在小程序-我的-顶上ID数字就是
# 支持多账户
customerId = ['']


def run(customerId, showCouponDetail=False):
    headers = {
    ...
    print(f'{customerId}正在执行:')
    # 获取fromUserName
    url = 'https://www.24geban.com/wechat/applet/order/list.jhtml'
    data = {
    ...
    fromUserName = response.json()['customer']['fromUserName']
